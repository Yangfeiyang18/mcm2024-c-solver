...
def main() -> None:
    ...
    solution = read_csv(RESULTS_DIR / "q1_full_waste_solution_long.csv")
    metrics_path = RESULTS_DIR / "q1_full_waste_metrics.json"
    ...
    write_csv(
        RESULTS_DIR / "q1_full_waste_constraint_audit.csv",
