...
CONFIG_PATH = PROJECT_ROOT / "config" / "q1_full_waste.json"
...
def main() -> None:
    ...
    model.setOptionValue("log_file", str(LOGS_DIR / "q1_full_waste_solver.log"))
    ...
    write_csv(
        RESULTS_DIR / "q1_full_waste_solution_long.csv",
    ...
    write_csv(
        RESULTS_DIR / "q1_full_waste_yearly_profit.csv",
    ...
    write_csv(
        RESULTS_DIR / "q1_full_waste_crop_summary.csv",
    ...
    (RESULTS_DIR / "q1_full_waste_metrics.json").write_text(json.dumps(metrics, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    (LOGS_DIR / "q1_full_waste_solver_summary.log").write_text(
        "\n".join(
            [
